...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>VitalikGPT</title>
        <meta
          name="description"
          content={`AI-powered search and chat for Vitalik Buterin's musings.`}
        />
        <meta
          name="viewport"
        ...
        <div className="flex-1 overflow-auto">
          <div className="mx-auto flex h-full w-full max-w-[750px] flex-col items-center px-3 pt-4 sm:pt-8">
            ...
            {loading ? (
              ...
              <div className="mt-6 text-center text-lg">{`Crypto AI-powered search & chat for Vitalik Buterin's essays.`}</div>
            )}
          </div>
        </div>
        <Footer />
